...
def phicture(score,output):
    ...
    title_font = ImageFont.truetype('src/font.ttf',size = 240)
    draw.text((130,130),'Phicture',fill=(255,255,255),font=title_font)
    level_font = ImageFont.truetype('src/font.ttf',size = 28)
    song_font = ImageFont.truetype('src/font.ttf',size = 50)
    composer_font = ImageFont.truetype('src/font.ttf',size = 30)
    rks_font = ImageFont.truetype('src/font.ttf',size = 70)
    ...
    phi_pic = Image.open('src/phi15phi.png')
    v_pic = Image.open('src/V15V.png').convert('RGBA')
    s_pic = Image.open('src/S15S.png').convert('RGBA')
    a_pic = Image.open('src/A15A.png').convert('RGBA')
    b_pic = Image.open('src/B15B.png').convert('RGBA')
    c_pic = Image.open('src/C15C.png').convert('RGBA')
    f_pic = Image.open('src/F15F.png').convert('RGBA')
    fc_pic = Image.open('src/V15FC.png').convert('RGBA')
    width = 512*4
    height = 170
    offset = 230*2
    blank = 10*2
